    ...
    return (
        <div>
            <div className=' container mx-auto px-4 mt-5 '>
                <div className="p-5 rounded-lg bg-pink-200 drop-shadow-xl border border-white-200"
                    style={{
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <button className="px-4 py-2 bg-pink-50 hover:bg-pink-300 drop-shadow-x1 text-gray-800 text-sm font-medium rounded-md" style={{ color: mode === 'dark' ? 'white' : '' }}>
                            Reset Filter
                        </button>
                    </div>
                    <div>
